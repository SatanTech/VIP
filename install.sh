...
#########################
REPO1="https://raw.githubusercontent.com/SatanTech/abc/main/"
REPO="https://raw.githubusercontent.com/SatanTech/scriptvps/main/"
CDNF="https://raw.githubusercontent.com/SatanTech/VIP/main"
###
BURIQ () {
...
echo ""
wget -q https://raw.githubusercontent.com/SatanTech/VIP/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/SatanTech/VIP/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install XRAY!"
sleep 2
clear
wget https://raw.githubusercontent.com/SatanTech/VIP/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
echo -e "$green[INFO]$NC Install SET-BR!"
wget https://raw.githubusercontent.com/SatanTech/VIP/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
echo -e "$green[INFO]$NC Install WEBSOCKET!"
wget https://raw.githubusercontent.com/SatanTech/VIP/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
wget https://raw.githubusercontent.com/SatanTech/VIP/main/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
clear
echo -e "$green[INFO]$NC Download Extra Menu"
sleep 2
wget https://raw.githubusercontent.com/SatanTech/VIP/main/update/update.sh && chmod +x update.sh && ./update.sh
rm -f update.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/SatanTech/VIP/main/version  )
